                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Row(
                            children: [
                              SmallIcon(
                                ...
                                color: Color.fromARGB(210, 234, 94, 94),
                              ),
                              SizedBox(
                                width: 10,
                              ),
                              SmallIcon(
                                text: 'something',
                                icon: Icons.type_specimen,
                                color: Color.fromARGB(211, 94, 234, 99),
                              ),
                            ],
                          ),
                          const SizedBox(
                          ...
                          const Text(
                            'hweoij  woefj wioj efwioef ioje fwoiejf oije foiwjf eofijwoeif eifj woeifj weofij wfowiefj weifjw  ieojfw ieofjw ',
                            style: TextStyle(
                                fontSize: 10,
                                fontWeight: FontWeight.bold,
